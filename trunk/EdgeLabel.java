 ...
 *
 */
public class EdgeLabel extends JApplet {
...
//        graph.addEdge(new DirectedSparseEdge(v[1], v[0]));
        graph.addEdge(new UndirectedSparseEdge(v[1], v[0]));
        graph.addEdge(new UndirectedSparseEdge(v[1], v[2]));
        graph.addEdge(new UndirectedSparseEdge(v[0], v[2]));
